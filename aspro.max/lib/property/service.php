...
class Service{
	...
	static function PrepareSettings($arFields){
		...
		$arFields['USER_TYPE_SETTINGS']['IS_READONLY'] = isset($arFields['USER_TYPE_SETTINGS']['IS_READONLY']) && $arFields['USER_TYPE_SETTINGS']['IS_READONLY'] === 'Y' ? 'Y' : 'N';

		$arFields['USER_TYPE_SETTINGS']['IS_HIDDEN'] = isset($arFields['USER_TYPE_SETTINGS']['IS_HIDDEN']) && $arFields['USER_TYPE_SETTINGS']['IS_HIDDEN'] === 'Y' ? 'Y' : 'N';

		$arFields['USER_TYPE_SETTINGS']['NOTE'] = isset($arFields['USER_TYPE_SETTINGS']['NOTE']) && strlen($arFields['USER_TYPE_SETTINGS']['NOTE']) ? $arFields['USER_TYPE_SETTINGS']['NOTE'] : Loc::getMessage('SERVICE_PROP_NOTE_VALUE_DEFAULT');
