...
$iblockShortCODE = "banners_catalog";
...
if($iblockID){
	...
	CWizardUtil::ReplaceMacrosRecursive($wizardSitePath, Array("IBLOCK_BANNERS_CATALOG_TYPE" => $iblockTYPE));
	CWizardUtil::ReplaceMacrosRecursive($wizardSitePath, Array("IBLOCK_BANNERS_CATALOG_ID" => $iblockID));
	CWizardUtil::ReplaceMacrosRecursive($wizardSitePath, Array("IBLOCK_BANNERS_CATALOG_CODE" => $iblockCODE));
	CWizardUtil::ReplaceMacrosRecursive($bitrixTemplateDir, Array("IBLOCK_BANNERS_CATALOG_TYPE" => $iblockTYPE));
	CWizardUtil::ReplaceMacrosRecursive($bitrixTemplateDir, Array("IBLOCK_BANNERS_CATALOG_ID" => $iblockID));
	CWizardUtil::ReplaceMacrosRecursive($bitrixTemplateDir, Array("IBLOCK_BANNERS_CATALOG_CODE" => $iblockCODE));
}
?>
