...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_0").'--,--ID--#--'.GetMessage("WZD_OPTION_2").'--,--DATE_CREATE--#--'.GetMessage("WZD_OPTION_4").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_6").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_8").'--,--ACTIVE_TO--#--'.GetMessage("WZD_OPTION_10").'--,--NAME--#--'.GetMessage("WZD_OPTION_12").'--,--XML_ID--#--'.GetMessage("WZD_OPTION_14").'--,--SORT--#--'.GetMessage("WZD_OPTION_16").'--,--IBLOCK_ELEMENT_PROP_VALUE--#--'.GetMessage("WZD_OPTION_18").'--,--PROPERTY_'.$arProperty["IMG"].'--#--'.GetMessage("WZD_OPTION_20").'--,--PROPERTY_'.$arProperty["SHOW_TEXT"].'--#--'.GetMessage("WZD_OPTION_22").'--,--PROPERTY_'.$arProperty["URL"].'--#--'.GetMessage("WZD_OPTION_24").'--,--PROPERTY_'.$arProperty["TYPE"].'--#--'.GetMessage("WZD_OPTION_26").'--;----#--'.GetMessage("WZD_OPTION_28").'--;--',
	));
	// list user options
...
if($iblockID){
	...
	CWizardUtil::ReplaceMacrosRecursive($wizardSitePath, Array("IBLOCK_BOTTOM_ICONS_TYPE" => $iblockTYPE));
	CWizardUtil::ReplaceMacrosRecursive($wizardSitePath, Array("IBLOCK_BOTTOM_ICONS_ID" => $iblockID));
	CWizardUtil::ReplaceMacrosRecursive($wizardSitePath, Array("IBLOCK_BOTTOM_ICONS_CODE" => $iblockCODE));
	CWizardUtil::ReplaceMacrosRecursive($bitrixTemplateDir, Array("IBLOCK_BOTTOM_ICONS_TYPE" => $iblockTYPE));
	CWizardUtil::ReplaceMacrosRecursive($bitrixTemplateDir, Array("IBLOCK_BOTTOM_ICONS_ID" => $iblockID));
	CWizardUtil::ReplaceMacrosRecursive($bitrixTemplateDir, Array("IBLOCK_BOTTOM_ICONS_CODE" => $iblockCODE));
}
?>
