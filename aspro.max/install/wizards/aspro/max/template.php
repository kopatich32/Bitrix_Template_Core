<?php
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"].BX_ROOT."/modules/main/install/wizard_sol/template.php");
...
class WizardTemplate extends CWizardTemplate
{
	function GetLayout()
	{
		...
		elseif(GetMessage("WIZARD_TITLE_PRODUCT_NAME")!="")
			$title = GetMessage("WIZARD_TITLE_PRODUCT_NAME");
		else
